                ...
                <div class="card card-custom p-4 bg-white">
                    ...
                    <form action="{{ route('admin.galeri.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nama_tempat" class="form-control rounded-3" placeholder="Contoh: Lab Komputer 1" required>
                        </div>
                        <div class="mb-4">
                            <label class="form-label small fw-semibold text-muted">Pilih Foto</label>
                            <input type="file" name="foto" class="form-control rounded-3" accept="image/*" required>
                        </div>
                        <button type="submit" class="btn btn-warning text-white w-100 rounded-3 py-2 fw-bold">
                ...
                <div class="card card-custom p-4 bg-white">
                    ...
                    <div class="row g-3">
                        @forelse($galeris ?? $galeri ?? [] as $g)
                            <div class="col-md-6">
                                <div class="card border rounded-4 overflow-hidden h-100 shadow-sm transition">
                                    ...
                                    <div class="card-body d-flex justify-content-between align-items-center bg-white p-3">
                                        ...
                                        <div class="d-flex gap-1">
                                            ...
                                            <form action="{{ route('admin.galeri.destroy', $g->id) }}" method="POST">
                                                @csrf 
                                                @method('DELETE')
                                                <button type="submit" class="btn btn-outline-danger btn-sm border-0 rounded-circle" onclick="return confirm('Apakah Anda yakin ingin menghapus foto ini?')" title="Hapus">
                                    ...
                                    <div class="modal-content border-0 rounded-4 shadow">
                                        <form action="{{ route('admin.galeri.update', $g->id) }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="modal-body py-3">
                                                <div class="mb-3">
                                                    <label class="form-label small fw-semibold text-muted">Nama Tempat / Lokasi</label>
                                                    <input type="text" name="nama_tempat" class="form-control rounded-3" value="{{ $g->nama_tempat }}" required>
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label small fw-semibold text-muted">Ganti Foto <small class="text-muted fw-normal">(Kosongkan jika tidak diubah)</small></label>
